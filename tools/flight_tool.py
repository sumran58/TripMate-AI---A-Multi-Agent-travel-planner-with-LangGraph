import os
import re
import certifi #helps Python securely connect to HTTPS websites.
import airportsdata #airports information using the codes of the airports 
import pycountry #gives us the info bout the country thrit lnguages,currencies and other iso stndards
...
DEFAULT_ORIGIN_IATA=os.getenv("DEFAULT_ORIGIN_IATA","IND")
